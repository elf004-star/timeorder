...
class TrainingGUI:
    ...
    def run_prediction(self, model_path: str, data_path: str, output_path: str):
        ...
        try:
            ...
            # 6. 规则修正
            corrected_predictions = self.predictor.apply_rules(df_with_features, predictions)
            ...
            result_df['corrected_status'] = corrected_predictions
            
            # 添加状态描述
            status_map = {0: 'Vertical', 1: 'Build-up', 2: 'Hold', 3: 'Drop-off'}
            result_df['status_desc'] = result_df['corrected_status'].map(status_map)
